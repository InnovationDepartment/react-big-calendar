...
var CampaignEvent = function (_React$Component) {
  _inherits(CampaignEvent, _React$Component);

  function CampaignEvent() {
    _classCallCheck(this, CampaignEvent);

    return _possibleConstructorReturn(this, _React$Component.apply(this, arguments));
  }

  CampaignEvent.prototype.render = function render() {
    var event = this.props.event;

    return _react2.default.createElement('div', { style: { backgroundColor: event.color, height: '4px' } });
  };

  return CampaignEvent;
}(_react2.default.Component);

var EventCell = function (_React$Component2) {
  _inherits(EventCell, _React$Component2);
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(CampaignEvent, { event: event, title: title, isAllDay: allDay })
          )
        )
      )
    );
