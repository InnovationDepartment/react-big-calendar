...
var BackgroundCells = function (_React$Component) {
  ...
  BackgroundCells.prototype.render = function render() {
    ...
    var hasOffRange = range.some(function (date) {
      return _dates2.default.month(currentDate) !== _dates2.default.month(date);
    });

    return _react2.default.createElement(
      'div',
      {
        className: (0, _classnames2.default)('rbc-row-bg', hasOffRange ? 'rbc-off-range-bg-row' : '')
      },
