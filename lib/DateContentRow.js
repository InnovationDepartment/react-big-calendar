...
var DateContentRow = function (_React$Component) {
  ...
  DateContentRow.prototype.render = function render() {
    ...
    var longEventSegments = segments.filter(function (segment) {
      return segment.span > 1;
    });

    var _eventLevels = (0, _eventLevels2.eventLevels)(longEventSegments, Math.max(maxRows - 1, 1)),
        levels = _eventLevels.levels,
        extra = _eventLevels.extra;

    var longLevels = levels.filter(function (level) {
      return;
    });
